...
export interface UseRealtimeOpts<T extends Record<string, unknown>, E extends string> {
  events?: readonly E[]
...
export function useRealtime<T extends Record<string, unknown>, const E extends EventPaths<T>>(
  ...
  useEffect(() => {
    ...
    context.register(registrationId, validChannels, (msg) => {
      ...
      if (result.success) {
        ...
        const payload = { event, data, channel } as unknown as EventPayloadUnion<T, E>
